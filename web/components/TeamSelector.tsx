    ...
    <div className="space-y-2">
      ...
      >
        ...
        <div className="text-center">
          <div className="text-2xl sm:text-3xl md:text-2xl lg:text-3xl font-mono font-bold uppercase tracking-wider transition-all group-hover:scale-105" style={{ color: 'hsl(var(--primary))' }}>
            {displayText}
          </div>
      ...
      {isOpen && (
        <>
          ...
          {/* Modal */}
          <div className="fixed inset-4 sm:inset-auto sm:left-1/2 sm:top-1/2 sm:-translate-x-1/2 sm:-translate-y-1/2 sm:w-full sm:max-w-3xl sm:max-h-[80vh] scoreboard-panel z-50 overflow-hidden flex flex-col">
            {/* Header */}
