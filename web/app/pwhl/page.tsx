...
export const metadata: Metadata = {
  ...
  description: 'Track the PWHL lineal championship belt from 2024 to present. See who holds the belt, upcoming title bouts, and complete history.',
  keywords: ['PWHL', 'championship belt', 'lineal title', 'women\'s hockey', 'belt tracker', 'PWHL stats', 'professional women\'s hockey'],
  alternates: {
    canonical: 'https://whohasthebelt.com/pwhl'
  },
  openGraph: {
    title: 'PWHL Championship Belt Tracker',
    description: 'The lineal championship belt - every game is a title defense. Track the PWHL belt from 2024 to present.',
  ...
  twitter: {
    ...
    title: 'PWHL Championship Belt Tracker',
    description: 'Track the PWHL lineal championship belt from 2024 to present. Every game is a title defense.',
