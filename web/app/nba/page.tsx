...
export const metadata: Metadata = {
  ...
  description:
    'Track the NBA lineal championship belt from 1976 to present. See who holds the belt, upcoming title bouts, and complete history.',
  keywords: [
    'NBA',
    'championship belt',
    'lineal title',
  ...
  openGraph: {
    ...
    description:
      'The lineal championship belt - every game is a title defense. Track the NBA belt from 1976 to present.',
  ...
  twitter: {
    ...
    title: 'NBA Championship Belt Tracker',
    description:
      'Track the NBA lineal championship belt from 1976 to present. Every game is a title defense.',
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    },
    {
      ...
      position: 2,
      name: 'NBA',
      item: 'https://whohasthebelt.com/nba',
    },
  ],
}
