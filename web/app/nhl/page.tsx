...
export const metadata: Metadata = {
  ...
  description:
    'Track the NHL lineal championship belt from 1942 to present. See who holds the belt, upcoming title bouts, and complete history.',
  keywords: [
    'NHL',
    'championship belt',
    'lineal title',
  ...
  openGraph: {
    ...
    description:
      'The lineal championship belt - every game is a title defense. Track the NHL belt from 1942 to present.',
  ...
  twitter: {
    ...
    title: 'NHL Championship Belt Tracker',
    description:
      'Track the NHL lineal championship belt from 1942 to present. Every game is a title defense.',
...
export default function NhlPage() {
  ...
  return (
    <>
      ...
      <NhlClient seasons={seasons} franchises={franchises} champions={champions} />
    </>
  )
}
