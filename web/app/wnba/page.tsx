...
export const metadata: Metadata = {
  ...
  description:
    'Track the WNBA lineal championship belt from 1997 to present. See who holds the belt, upcoming title bouts, and complete history.',
  keywords: [
    'WNBA',
    'championship belt',
    'lineal title',
  ...
  openGraph: {
    ...
    description:
      'The lineal championship belt - every game is a title defense. Track the WNBA belt from 1997 to present.',
  ...
  twitter: {
    ...
    title: 'WNBA Championship Belt Tracker',
    description:
      'Track the WNBA lineal championship belt from 1997 to present. Every game is a title defense.',
